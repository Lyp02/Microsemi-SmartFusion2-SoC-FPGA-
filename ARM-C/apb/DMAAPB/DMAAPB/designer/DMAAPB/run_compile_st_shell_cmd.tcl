...
save
set has_violations {D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\designer\DMAAPB\DMAAPB_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\designer\DMAAPB\DMAAPB_combinational_loops.xml}
if { [catch "file delete -force -- {D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\designer\DMAAPB\pinslacks.txt}"] } {
   ;
}
report -type slack {D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\designer\DMAAPB\pinslacks.txt}
