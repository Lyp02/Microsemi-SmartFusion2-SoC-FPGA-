...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\synthesis\DMAAPB.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\constraint\io\DMAAPB.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\constraint\fp\DMAAPB.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M1000_N \
    -pkg tq144 \
    -pdc_file {D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\constraint\io\DMAAPB.io.pdc} \
    -pdc_file {D:\M2S010TQG144\EDIB_1\DMAAPB\DMAAPB\constraint\fp\DMAAPB.fp.pdc} \
    -merge_pdc 0
